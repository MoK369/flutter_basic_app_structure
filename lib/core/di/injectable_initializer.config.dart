...
import '../api/callers/dio/dio_service.dart' as _i1039;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    await gh.factoryAsync<_i990.InitialTheme>(
      () => themeInitializer.getInitCurrentTheme(gh<_i349.StorageService>()),
...
class _$DioService extends _i1039.DioService {}
